#!/usr/bin/env bash
# Acceptance probe for the whole-file similarity legal gate (Mesh #f3eb7b30).
#
...
#
#   ./scripts/check-derivativeness.sh                 # vs the pinned baseline commit (default)
#   ./scripts/check-derivativeness.sh --upstream HEAD # vs the baseline's current main
